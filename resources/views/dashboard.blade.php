                ...
                <div class="col-lg-9 col-md-12">
                    <form method="GET" action="{{ route('dashboard') }}" class="row g-3">
                        <div class="col-lg-8 col-md-8 col-sm-12">
                            <select name="user_id" class="form-select" style="padding: 12px 16px; font-size: 14px; border-radius: 8px; border: 2px solid rgba(255,255,255,0.3); background-color: rgba(255,255,255,0.95); font-weight: 500;" onchange="this.form.submit()">
                                ...
                                @foreach($adminUsers as $admin)
                                    <option value="{{ $admin->id }}" {{ $selectedUserId == $admin->id ? 'selected' : '' }}>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <a href="{{ route('users.index') }}" class="btn btn-light w-100" style="padding: 12px; font-weight: 600; border-radius: 8px; box-shadow: 0 2px 6px rgba(0,0,0,0.1);">
            ...
            @else
                ...
                @if($selectedAdmin)
                    <div class="alert alert-light mt-3 mb-0" style="border-radius: 8px; background-color: rgba(255,255,255,0.95); border: none;">
                        ...
                        <strong>Filter Aktif:</strong> Menampilkan data untuk admin <strong>{{ $selectedAdmin->name }}</strong>
                    </div>
                @endif
            @endif
        </div>
            ...
            <div class="stat-card blue" style="height: 100%; min-height: 140px; display: flex; flex-direction: column; justify-content: center;">
                <div class="row" style="margin: 0;">
                    <div class="col-8">
                        ...
                        <div class="stat-value" id="total-sales" style="font-size: 20px; font-weight: 700;">Rp {{ number_format($totalSales, 0, ',', '.') }}</div>
                    </div>
            ...
            <div class="stat-card green" style="height: 100%; min-height: 140px; display: flex; flex-direction: column; justify-content: center;">
                <div class="row" style="margin: 0;">
                    <div class="col-8">
                        ...
                        <div class="stat-value" id="total-profit" style="font-size: 20px; font-weight: 700;">Rp {{ number_format($totalProfit, 0, ',', '.') }}</div>
                    </div>
                    <div class="col-4 stat-icon" style="display: flex; align-items: center; justify-content: center;">
            ...
            <div class="stat-card orange" style="height: 100%; min-height: 140px; display: flex; flex-direction: column; justify-content: center;">
                <div class="row" style="margin: 0;">
                    <div class="col-8">
                        ...
                        <div class="stat-value" id="total-purchases" style="font-size: 20px; font-weight: 700;">Rp {{ number_format($totalPurchases, 0, ',', '.') }}</div>
                    </div>
                    <div class="col-4 stat-icon" style="display: flex; align-items: center; justify-content: center;">
            ...
            <div class="stat-card red" style="height: 100%; min-height: 140px; display: flex; flex-direction: column; justify-content: center;">
                <div class="row" style="margin: 0;">
                    <div class="col-8">
                        ...
                        <div class="stat-value" id="total-saldo-modal" style="font-size: 20px; font-weight: 700;">Rp {{ number_format($totalSaldoModal, 0, ',', '.') }}</div>
                    </div>
                    <div class="col-4 stat-icon" style="display: flex; align-items: center; justify-content: center;">
                ...
                <div class="card-body" style="padding: 22px; background: linear-gradient(135deg, #f8fafc 0%, #ffffff 100%);">
                    <div class="row align-items-center g-3">
                        ...
                        <div class="col-lg-5 col-md-4">
                            <div style="display: flex; flex-wrap: wrap; gap: 10px; align-items: center;">
                                <span style="display: inline-flex; align-items: center; gap: 6px; padding: 8px 12px; border-radius: 999px; background: #ecfeff; color: #0f766e; font-size: 12px; font-weight: 700;">
                                    <i class="fas fa-piggy-bank"></i> Modal: Rp {{ number_format($totalSaldoModal, 0, ',', '.') }}
                                </span>
                                <span style="display: inline-flex; align-items: center; gap: 6px; padding: 8px 12px; border-radius: 999px; background: #f0fdf4; color: #15803d; font-size: 12px; font-weight: 700;">
                                    <i class="fas fa-cash-register"></i> Penjualan Masuk: Rp {{ number_format($totalSales, 0, ',', '.') }}
                                </span>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-4 text-lg-end">
                            <div id="saldo-modal-bersih" style="font-size: 28px; font-weight: 800; color: {{ $saldoModalBersih < 0 ? '#dc2626' : '#16a34a' }}; line-height: 1.1;">Rp {{ number_format($saldoModalBersih, 0, ',', '.') }}</div>
                    ...
                    @if($topProducts->count() > 0)
                        ...
                        <div style="display: flex; align-items: center; margin-bottom: 12px; padding: 12px; background: #f8f9fa; border-radius: 8px; border-left: 4px solid #fbc02d;">
                            ...
                            <div style="margin-left: 12px; flex: 1; min-width: 0;">
                                <p style="font-weight: 600; margin: 0; color: #1a1a1a; font-size: 13px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">{{ $product->produk->stockGudang->nama_produk ?? $product->produk->nama_produk ?? 'N/A' }}</p>
                                <p style="font-size: 11px; color: #999; margin: 3px 0 0 0;">{{ $product->total_qty ?? 0 }} pcs terjual</p>
                            </div>
                        </div>
                        @endforeach
                    @else
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <small class="chart-subtitle">{{ $stockStatus['total'] }} produk terdaftar</small>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card-body chart-body">
                    @if($stockStatus['total'] > 0)
                        <!-- Stock Stats Cards -->
                        <div class="stock-stats-grid">
                            <div class="stock-stat-item stock-stat-safe">
                                ...
                                <div class="stock-stat-info">
                                    <span class="stock-stat-value" id="stock-aman">{{ $stockStatus['stok_aman'] }}</span>
                            ...
                            <div class="stock-stat-item stock-stat-warning">
                                ...
                                <div class="stock-stat-info">
                                    <span class="stock-stat-value" id="stock-sedang">{{ $stockStatus['stok_sedang'] }}</span>
                            ...
                            <div class="stock-stat-item stock-stat-danger">
                                ...
                                <div class="stock-stat-info">
                                    <span class="stock-stat-value" id="stock-rendah">{{ $stockStatus['stok_rendah'] }}</span>
                ...
                <div class="card-body" style="padding: 25px;">
                    <div class="row" style="margin: 0;">
                        <div class="col-lg-2 col-md-3 col-sm-4 col-6 px-2 mb-3">
                            <a href="{{ route('penjualan.create') }}" class="btn btn-sm w-100" style="padding: 12px; background: linear-gradient(135deg, #00bcd4 0%, #0097a7 100%); color: white; border: none; border-radius: 8px; font-weight: 600; font-size: 12px; transition: all 0.3s ease; display: flex; align-items: center; justify-content: center;">
                                <i class="fas fa-plus" style="margin-right: 6px;"></i> Penjualan
                            </a>
                        </div>
                        <div class="col-lg-2 col-md-3 col-sm-4 col-6 px-2 mb-3">
                            <a href="{{ route('pembelian.create') }}" class="btn btn-sm w-100" style="padding: 12px; background: linear-gradient(135deg, #0d47a1 0%, #1565c0 100%); color: white; border: none; border-radius: 8px; font-weight: 600; font-size: 12px; transition: all 0.3s ease; display: flex; align-items: center; justify-content: center;">
                                <i class="fas fa-plus" style="margin-right: 6px;"></i> Pembelian
                            </a>
                        </div>
                        <div class="col-lg-2 col-md-3 col-sm-4 col-6 px-2 mb-3">
                            <a href="{{ route('produk-siap-jual.create') }}" class="btn btn-sm w-100" style="padding: 12px; background: linear-gradient(135deg, #2e7d32 0%, #43a047 100%); color: white; border: none; border-radius: 8px; font-weight: 600; font-size: 12px; transition: all 0.3s ease; display: flex; align-items: center; justify-content: center;">
                                <i class="fas fa-plus" style="margin-right: 6px;"></i> Produk
                            </a>
                        </div>
                        <div class="col-lg-2 col-md-3 col-sm-4 col-6 px-2 mb-3">
                            <a href="{{ route('suppliers.create') }}" class="btn btn-sm w-100" style="padding: 12px; background: linear-gradient(135deg, #c62828 0%, #e53935 100%); color: white; border: none; border-radius: 8px; font-weight: 600; font-size: 12px; transition: all 0.3s ease; display: flex; align-items: center; justify-content: center;">
                                <i class="fas fa-plus" style="margin-right: 6px;"></i> Supplier
                            </a>
                        </div>
                        <div class="col-lg-2 col-md-3 col-sm-4 col-6 px-2 mb-3">
                            <a href="{{ route('stock-gudang.create') }}" class="btn btn-sm w-100" style="padding: 12px; background: linear-gradient(135deg, #6a1b9a 0%, #7b1fa2 100%); color: white; border: none; border-radius: 8px; font-weight: 600; font-size: 12px; transition: all 0.3s ease; display: flex; align-items: center; justify-content: center;">
...
<script>
    ...
    const revenueData = {!! json_encode($weeklyRevenueVsCost) !!};
