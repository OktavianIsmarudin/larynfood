...
@section('title', 'Buat Produk Paket Baru')
...
<div class="container-fluid py-4" style="background-color: #F8FAFC; min-height: 100vh;">
    <div class="row">
        <div class="col-lg-10 mx-auto">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    ...
                    <h2 style="font-weight: 700; color: #1A1A1A; font-size: 32px; margin: 0;">
                        <i class="fas fa-layer-group" style="color: #8B5CF6; margin-right: 12px; opacity: 0.8;"></i> Buat Paket Baru
                    </h2>
                    <small style="color: #6B7280; font-size: 14px;">Komposisikan beberapa item dari stock gudang menjadi satu paket</small>
                </div>
            </div>
            ...
            <form action="{{ route('produk-paket.store') }}" method="POST" id="formPaket">
                @csrf
                    ...
                    <div class="card-body" style="padding: 24px;">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="nama_paket" class="form-control" value="{{ old('nama_paket') }}" required placeholder="Contoh: Nasi Box Spesial" style="border-radius: 8px; padding: 12px 16px; border: 1px solid #E5E7EB;">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="form-label" style="color: #374151; font-weight: 500;">Kode Paket</label>
                                <input type="text" name="kode_paket" class="form-control" value="{{ old('kode_paket') }}" placeholder="Contoh: PKT001" style="border-radius: 8px; padding: 12px 16px; border: 1px solid #E5E7EB;">
                            </div>
                            <div class="col-md-3 mb-3">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea name="deskripsi" class="form-control" rows="2" placeholder="Deskripsi singkat tentang paket ini" style="border-radius: 8px; padding: 12px 16px; border: 1px solid #E5E7EB;">{{ old('deskripsi') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <table class="table" id="tableItems" style="font-size: 14px;">
                                ...
                                <tfoot>
                                    <tr style="background-color: #F0F9FF; border-top: 2px solid #8B5CF6;">
                                        ...
                                        <td style="padding: 16px; text-align: right; font-weight: 700; color: #8B5CF6; font-size: 16px;" id="totalHpp">Rp 0</td>
                                        <td></td>
                                    </tr>
                                </tfoot>
                            </table>
                ...
                <div class="d-flex justify-content-end gap-3">
                    <a href="{{ route('produk-paket.index') }}" class="btn" style="background-color: #F3F4F6; color: #374151; border: 1px solid #E5E7EB; padding: 12px 24px; border-radius: 8px;">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // ====== EVENT LISTENERS ======
    btnTambah.addEventListener('click', addItemRow);
