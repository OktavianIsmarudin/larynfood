...
@section('title', 'Laryn - Sistem Inventory & Keuangan Bisnis Makanan')
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item-custom {{ $index === 0 ? 'active' : '' }}">
                ...
                <div class="carousel-content">
                    <h1>{{ $promo['title'] }}</h1>
                    <p>{{ $promo['subtitle'] }}</p>
                    <a id="heroOrderNowBtn" href="{{ url('/products') }}" class="btn btn-light btn-lg" style="padding: 15px 40px; font-weight: 600; border-radius: 8px;">
...
<section class="products-section" id="products">
    <div class="container">
                ...
                <div class="product-card">
                    ...
                    <div class="product-image">
                        @if($product->gambar_produk)
                            <img src="{{ asset('storage/' . $product->gambar_produk) }}" alt="{{ $product->nama_produk }}" style="width: 100%; height: 100%; object-fit: cover;">
                        @else
                    ...
                    <div class="product-body">
                        ...
                        <div class="text-muted mb-2" style="font-size: 12px;">
                            ...
                            Oleh: <strong>{{ $product->user->name }}</strong>
                        </div>
                        @endif
                        ...
                        <div class="product-badges">
                            ...
                            @if($product->stockGudang && $product->stockGudang->category)
                                <span class="badge-category">{{ $product->stockGudang->category->nama_kategori }}</span>
                            @endif
                        </div>
        ...
        <div class="text-center mt-5">
            <a href="{{ route('products.explore') }}" class="btn btn-primary-custom btn-lg">
...
<script>
    ...
    if (heroOrderNowBtn) {
        heroOrderNowBtn.addEventListener('click', function(event) {
            ...
            window.location.assign('{{ url('/products') }}');
        });
    }
</script>
@endpush
