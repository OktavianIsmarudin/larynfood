...
@section('title', 'Rekap Penjualan - Laporan')
...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form method="GET" action="{{ route('reports.sales-summary') }}" class="row g-3">
                        <div class="col-md-4">
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-3 mb-3">
            <div class="card" style="border: none; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 15px rgba(0, 188, 212, 0.15); background: linear-gradient(135deg, #00bcd4 0%, #0097a7 100%); color: white; transition: all 0.3s ease;">
                <div class="card-body" style="position: relative; z-index: 1;">
                    <p style="font-size: 12px; font-weight: 600; margin-bottom: 8px; text-transform: uppercase; letter-spacing: 0.5px; opacity: 0.95;">
                        <i class="fas fa-money-bill-wave"></i> Total Penjualan
                    </p>
                    <h2 style="font-weight: 700; margin: 0; font-size: 28px;">Rp {{ number_format($summaryStats['total_sales'], 0, ',', '.') }}</h2>
                </div>
                <div style="position: absolute; right: -20px; top: -20px; width: 120px; height: 120px; background: rgba(255, 255, 255, 0.1); border-radius: 50%;"></div>
            </div>
        </div>
        <div class="col-md-3 mb-3">
            <div class="card" style="border: none; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 15px rgba(255, 193, 7, 0.15); background: linear-gradient(135deg, #fbc02d 0%, #f57f17 100%); color: white; transition: all 0.3s ease;">
                <div class="card-body" style="position: relative; z-index: 1;">
                    ...
                    <h2 style="font-weight: 700; margin: 0; font-size: 28px;">Rp {{ number_format($summaryStats['average_sale'], 0, ',', '.') }}</h2>
                </div>
                <div style="position: absolute; right: -20px; top: -20px; width: 120px; height: 120px; background: rgba(255, 255, 255, 0.1); border-radius: 50%;"></div>
            </div>
        </div>
                ...
                <div class="card-body">
                            ...
                            <table class="table table-hover table-striped">
                                <thead class="table-primary">
                                    <tr>
                                        ...
                                        <th width="200" class="text-right">Total Penjualan</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <strong>Rp {{ number_format($data->total_sales, 0, ',', '.') }}</strong>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
                                <tfoot class="table-light">
                                    <tr>
                                        ...
                                        <th class="text-right"><strong>Rp {{ number_format($summaryStats['total_sales'], 0, ',', '.') }}</strong></th>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
                    @else
                        <div class="alert alert-info text-center">
                            <i class="fas fa-info-circle"></i> Tidak ada data penjualan untuk periode ini
                        </div>
                    @endif
                </div>
            </div>
