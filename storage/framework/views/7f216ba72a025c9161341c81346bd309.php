...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Laryn - Sistem Inventory UMKM'); ?></title>
    ...
    <div class="d-flex">
        ...
        <nav class="sidebar">
            ...
            <ul class="nav-menu">
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('stock-gudang.index')); ?>" class="nav-link <?php echo e(request()->routeIs('stock-gudang.*') ? 'active' : ''); ?>">
                        <i class="fas fa-warehouse"></i> Stock Gudang
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<?php echo e(route('produk-siap-jual.index')); ?>" class="nav-link <?php echo e(request()->routeIs('produk-siap-jual.*') ? 'active' : ''); ?>">
                        <i class="fas fa-box"></i> Produk Siap Jual
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<?php echo e(route('produk-paket.index')); ?>" class="nav-link <?php echo e(request()->routeIs('produk-paket.*') ? 'active' : ''); ?>">
                        <i class="fas fa-layer-group"></i> Produk Paket
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<?php echo e(route('bom.index')); ?>" class="nav-link <?php echo e(request()->routeIs('bom.*') ? 'active' : ''); ?>">
                        <i class="fas fa-file-recipe"></i> Bill of Material
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<?php echo e(route('nilai-gizi.index')); ?>" class="nav-link <?php echo e(request()->routeIs('nilai-gizi.*') ? 'active' : ''); ?>">
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('saldo-modal.index')); ?>" class="nav-link <?php echo e(request()->routeIs('saldo-modal.*') ? 'active' : ''); ?>">
                        <i class="fas fa-wallet"></i> Saldo Modal
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<?php echo e(route('pembelian.index')); ?>" class="nav-link <?php echo e(request()->routeIs('pembelian.*') ? 'active' : ''); ?>">
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('orders-management.index')); ?>" class="nav-link <?php echo e(request()->routeIs('orders-management.*') ? 'active' : ''); ?>">
                        <i class="fas fa-truck-fast"></i> Tracking Pesanan
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<?php echo e(route('financial-report.index')); ?>" class="nav-link <?php echo e(request()->routeIs('financial-report.*') ? 'active' : ''); ?>">
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('reports.top-products')); ?>" class="nav-link">
                        <i class="fas fa-chart-bar"></i> Produk Terlaris
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<?php echo e(route('reports.sales-summary')); ?>" class="nav-link">
                        <i class="fas fa-chart-line"></i> Rekap Penjualan
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<?php echo e(route('reports.purchase-summary')); ?>" class="nav-link">
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('knowledge-base.index')); ?>" class="nav-link <?php echo e(request()->routeIs('knowledge-base.*') ? 'active' : ''); ?>">
...
<?php /**PATH C:\Pongs\pengmas semester 8\sistem\sistem inventory\sistem inventory\resources\views/layouts/app.blade.php ENDPATH**/ ?>