...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Laryn - Sistem Inventory & Keuangan'); ?></title>
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-center">
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('landing')); ?>#home">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('products.explore')); ?>">Explore Produk</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('landing')); ?>#about">Tentang</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <button type="button" class="floating-cart-btn" id="floatingCartButton" aria-label="Buka keranjang">
        ...
        <span class="floating-cart-count" id="floatingCartCount"><?php echo e(count(session('cart', []))); ?></span>
    </button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="popup-card mb-3">
                        ...
                        <?php if($guestPaymentSetting?->qris_image_path): ?>
                        <div class="mb-3">
                            <p class="mb-1"><strong>QRIS</strong></p>
                            <img src="<?php echo e(asset('storage/' . $guestPaymentSetting->qris_image_path)); ?>" alt="QRIS" class="img-fluid rounded border" style="max-height: 260px;">
                        </div>
                        <?php endif; ?>

                        <?php if($guestPaymentSetting?->bank_name || $guestPaymentSetting?->account_number): ?>
                        <p class="mb-1"><?php echo e($guestPaymentSetting->bank_name ?? 'Bank'); ?>: <strong><?php echo e($guestPaymentSetting->account_number ?? '-'); ?></strong> (<?php echo e($guestPaymentSetting->account_holder ?? '-'); ?>)</p>
                        <?php else: ?>
                        <p class="mb-1">BCA: <strong>1234567890</strong> (Laryn)</p>
                        <p class="mb-0">Mandiri: <strong>9876543210</strong> (Laryn)</p>
                        <?php endif; ?>

                        <?php if($guestPaymentSetting?->instructions): ?>
                        <p class="mb-0 mt-2 text-muted"><?php echo e($guestPaymentSetting->instructions); ?></p>
                        <?php endif; ?>
                    </div>
    ...
    <footer class="footer-custom" id="contact">
        <div class="container">
            <div class="row gy-4 gx-5">
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <ul class="list-unstyled footer-links">
                        <li class="mb-2"><a href="<?php echo e(route('landing')); ?>#home">Home</a></li>
                        <li class="mb-2"><a href="<?php echo e(route('landing')); ?>#products">Produk</a></li>
                        <li class="mb-2"><a href="<?php echo e(route('landing')); ?>#about">Tentang</a></li>
                    </ul>
                </div>
            ...
            <div class="text-center" style="color: rgba(255, 255, 255, 0.7);">
                <p class="mb-0">&copy; <?php echo e(date('Y')); ?> Laryn. All rights reserved.</p>
            </div>
        </div>
    </footer>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const cartDataUrl = '<?php echo e(route('customer.cart.data')); ?>';
            const cartUpdateUrl = '<?php echo e(route('customer.cart.update')); ?>';
            const checkoutUrl = '<?php echo e(route('customer.checkout.process')); ?>';
            const trackStatusTemplate = '<?php echo e(route('customer.track.status', ['orderNumber' => '__ORDER__'])); ?>';
            const cartRemoveTemplate = '<?php echo e(route('customer.cart.remove', ['id' => '__ID__'])); ?>';
            const chatbotMessageUrl = '<?php echo e(route('chatbot.message')); ?>';
            ...
            const chatbotProfilesUrl = '<?php echo e(route('chatbot.profiles')); ?>';
            ...
            document.getElementById('orderAgainBtn').addEventListener('click', function() {
                ...
                localStorage.removeItem('last_tracked_order');
                localStorage.removeItem('tracking_modal_open');
                window.location.href = '<?php echo e(route('products.explore')); ?>';
            });
...
<?php /**PATH C:\Pongs\pengmas semester 8\sistem\sistem inventory\sistem inventory\resources\views/layouts/guest.blade.php ENDPATH**/ ?>